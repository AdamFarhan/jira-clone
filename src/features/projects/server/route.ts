...
const app = new Hono()
  ...
  .get(
    ...
    async (c) => {
      ...
      //if user is not a member of this workspace, don't return the workspace's projects
  ...
  .post(
    ...
    async (c) => {
      ...
      //if user is not a member of the workspace, prevent them from creating projects there
      const member = await getMember({
        databases,
        workspaceId,
        userId: user.$id,
