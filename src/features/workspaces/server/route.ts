...
const app = new Hono()
  ...
  .post(
    ...
    async (c) => {
      ...
      // Get user's membership and prevent them from joining a workspace they're already in
      const member = await getMember({
        databases,
        workspaceId,
        userId: user.$id,
